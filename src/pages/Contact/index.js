            ...
            <div className="container">
                <div className="flex flex-col justify-center items-center">
                    <div className="text-center w-full sm:w-3/4">
                        ...
                        <p className={cx('', isDarkMode ? 'text-colorLight' : 'text-colorDark')}>Bạn có đề xuất hoặc phản hồi? Chúng tôi rất sẵn sàng nghe ý kiến từ bạn! Sử dụng mẫu dưới đây để chia sẻ suy nghĩ của bạn. Cảm ơn bạn đã giúp chúng tôi cải thiện!</p>
                    </div>
